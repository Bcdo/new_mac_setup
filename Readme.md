...
> Just another automated new mac setuo. Fork the repo and alter the brew file and the
...
The SysSettings/setup.sh will configure system settings. Example of this is changing the default saving path for screenshots to the _Downloads_ folder instead of _Dekstop_
